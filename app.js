...
function settings(){
  shell(header('Einstellungen','Grundeinstellungen für KOMPASS.') + `
    <div class="card">
      <h2>Aktueller Stand</h2>
      <p>Lehrkräfte, Rollen und Schuljahr werden später hier verwaltet. Aktuell bleiben diese Einstellungen bewusst einfach.</p>
    </div>
  `);
}
