const Store = {
  ...
  exportData(){
    return {version:'3.9', exportedAt:new Date().toISOString(), sprints:this.sprints, subjects:this.subjects, pupils:this.pupils, competencies:this.competencies, records:this.records, lebDrafts:this.lebDrafts, metadata:this.metadata};
  },
  importData(data){
