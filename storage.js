  ...
  load(){
    ...
    if(legacy){
      this.data = {
        ...
        activities:[], activityRecords:{}, behaviour:{}, coaching:{}, projectTemplates:clone(SEED.projectTemplates),creativeRooms:clone(SEED.creativeRooms),workshopPaths:{},clubMemberships:{},assignments:[],choiceImports:[],sprintHistory:{},clubHistory:{},dailyCreativeVisits:{},
        metadata: JSON.parse(localStorage.getItem('kompass33_metadata') || '{}')
      };
      this.migrate(); this.save(); return;
    }
    this.data = {version:'6.0',subjects:clone(SEED.subjects),coreSubjects:clone(SEED.coreSubjects),sprints:clone(SEED.sprints),pupils:clone(SEED.pupils),competencies:clone(SEED.competencies),records:{},lebDrafts:{},activities:[],activityRecords:{},behaviour:{},coaching:{},settings:{scoreConfig:{...DEFAULT_SCORE_CONFIG}},projectTemplates:clone(SEED.projectTemplates),creativeRooms:clone(SEED.creativeRooms),workshopPaths:{},clubMemberships:{},assignments:[],choiceImports:[],sprintHistory:{},clubHistory:{},dailyCreativeVisits:{},metadata:{createdAt:new Date().toISOString(),version:'6.0'}};
    this.save();
  },
  migrate(){
    const d=this.data;
    ...
    d.projectTemplates=d.projectTemplates||clone(SEED.projectTemplates); d.creativeRooms=d.creativeRooms||clone(SEED.creativeRooms); d.workshopPaths=d.workshopPaths||{}; d.clubMemberships=d.clubMemberships||{};
    d.settings=d.settings||{};
    d.settings.scoreConfig=d.settings.scoreConfig||{...DEFAULT_SCORE_CONFIG};
    d.metadata=d.metadata||{};
    d.metadata.version='6.0';
