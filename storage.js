...
const Store = {
  ...
  migrate(){
    ...
    d.timetable.generator=d.timetable.generator||{periods:9,corePeriods:[2,3,4],latePeriods:[5,6],maxTeacherDay:7,avoidFirstCore:true,lastRun:null,report:null};
    d.settings=d.settings||{};
    d.settings.scoreConfig=d.settings.scoreConfig||{...DEFAULT_SCORE_CONFIG};
    d.metadata=d.metadata||{};
    d.metadata.version='7.0';
