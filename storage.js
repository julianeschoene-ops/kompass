...
Object.defineProperties(Store,{sprints:{get(){return Array.isArray(this.data?.sprints)?this.data.sprints:[]},set(v){this.data.sprints=Array.isArray(v)?v:[]}},subjects:{get(){return this.data.subjects},set(v){this.data.subjects=v}},coreSubjects:{get(){return this.data.coreSubjects},set(v){this.data.coreSubjects=v}},pupils:{get(){return Array.isArray(this.data?.pupils)?this.data.pupils:[]},set(v){this.data.pupils=Array.isArray(v)?v:[]}},competencies:{get(){return Array.isArray(this.data?.competencies)?this.data.competencies:[]},set(v){this.data.competencies=Array.isArray(v)?v:[]}},records:{get(){return this.data.records},set(v){this.data.records=v}},lebDrafts:{get(){return this.data.lebDrafts},set(v){this.data.lebDrafts=v}},activities:{get(){return Array.isArray(this.data?.activities)?this.data.activities:[]},set(v){this.data.activities=Array.isArray(v)?v:[]}},activityRecords:{get(){return this.data.activityRecords},set(v){this.data.activityRecords=v}},behaviour:{get(){return this.data.behaviour},set(v){this.data.behaviour=v}},coaching:{get(){return this.data.coaching},set(v){this.data.coaching=v}},settings:{get(){return this.data.settings},set(v){this.data.settings=v}},metadata:{get(){return this.data.metadata},set(v){this.data.metadata=v}},projectTemplates:{get(){return this.data.projectTemplates},set(v){this.data.projectTemplates=v}},creativeRooms:{get(){return this.data.creativeRooms},set(v){this.data.creativeRooms=v}},workshopPaths:{get(){return this.data.workshopPaths},set(v){this.data.workshopPaths=v}},clubMemberships:{get(){return this.data.clubMemberships},set(v){this.data.clubMemberships=v}},assignments:{get(){return Array.isArray(this.data?.assignments)?this.data.assignments:[]},set(v){this.data.assignments=Array.isArray(v)?v:[]}},choiceImports:{get(){return this.data.choiceImports},set(v){this.data.choiceImports=v}},sprintHistory:{get(){return this.data.sprintHistory},set(v){this.data.sprintHistory=v}},clubHistory:{get(){return this.data.clubHistory},set(v){this.data.clubHistory=v}},dailyCreativeVisits:{get(){return this.data.dailyCreativeVisits},set(v){this.data.dailyCreativeVisits=v}},calendarEvents:{get(){return Array.isArray(this.data?.calendarEvents)?this.data.calendarEvents:[]},set(v){this.data.calendarEvents=Array.isArray(v)?v:[]}},auditLog:{get(){return Array.isArray(this.data?.auditLog)?this.data.auditLog:[]},set(v){this.data.auditLog=Array.isArray(v)?v:[]}},timetable:{get(){return this.data.timetable},set(v){this.data.timetable=v}}});
