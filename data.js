const SEED = {
  ...
  subjects: ['Geographie','Geschichte','Informatik & Medienbildung','BK','Musik','Deutsch','Mathematik','Englisch'],
  pupils: [
...
,
    {id:'de_5_lesen', year:5, sprint:null, subject:'Deutsch', area:'Lesen', level:'G/M/E', kind:'kern', includeInLeb:true, scoreConfig:{redMax:49,yellowMax:74}, text:'Ich kann Texte genau lesen und wichtige Informationen entnehmen.'},
    {id:'de_5_schreiben', year:5, sprint:null, subject:'Deutsch', area:'Schreiben', level:'G/M/E', kind:'kern', includeInLeb:true, scoreConfig:{redMax:49,yellowMax:74}, text:'Ich kann eigene Texte verständlich und passend zur Aufgabe schreiben.'},
    {id:'de_5_sprache', year:5, sprint:null, subject:'Deutsch', area:'Sprache untersuchen', level:'G/M/E', kind:'kern', includeInLeb:true, scoreConfig:{redMax:49,yellowMax:74}, text:'Ich kann sprachliche Strukturen erkennen und richtig anwenden.'},
    {id:'ma_5_zahlen', year:5, sprint:null, subject:'Mathematik', area:'Zahlen und Rechnen', level:'G/M/E', kind:'kern', includeInLeb:true, scoreConfig:{redMax:49,yellowMax:74}, text:'Ich kann mit Zahlen sicher rechnen und Rechenwege nachvollziehbar darstellen.'},
    {id:'ma_5_geometrie', year:5, sprint:null, subject:'Mathematik', area:'Geometrie', level:'G/M/E', kind:'kern', includeInLeb:true, scoreConfig:{redMax:49,yellowMax:74}, text:'Ich kann geometrische Figuren erkennen, beschreiben und zeichnen.'},
    {id:'ma_5_sach', year:5, sprint:null, subject:'Mathematik', area:'Sachaufgaben', level:'G/M/E', kind:'kern', includeInLeb:true, scoreConfig:{redMax:49,yellowMax:74}, text:'Ich kann Sachaufgaben verstehen, passende Rechenwege wählen und Ergebnisse prüfen.'},
    {id:'en_5_words', year:5, sprint:null, subject:'Englisch', area:'Wortschatz', level:'G/M/E', kind:'kern', includeInLeb:true, scoreConfig:{redMax:49,yellowMax:74}, text:'I can use familiar words and phrases correctly.'},
    {id:'en_5_reading', year:5, sprint:null, subject:'Englisch', area:'Reading', level:'G/M/E', kind:'kern', includeInLeb:true, scoreConfig:{redMax:49,yellowMax:74}, text:'I can understand simple English texts and find important information.'},
    {id:'en_5_speaking', year:5, sprint:null, subject:'Englisch', area:'Speaking', level:'G/M/E', kind:'kern', includeInLeb:true, scoreConfig:{redMax:49,yellowMax:74}, text:'I can take part in simple conversations and talk about familiar topics.'}
